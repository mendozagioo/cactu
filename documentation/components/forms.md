...
| Name  | Type  | Value |
| ----- | ----- | ----- |
| `$input-color`                      | <small>color</small> | <span class="small-box" style="background:#343a40"></span> `$text-color` |
| `$input-background`                 | <small>color</small> | <span class="small-box" style="background:#fff"></span> `$white` |
| `$input-padding`                    | <small>padding</small> | `.375rem .75rem` |
| `$input-border`                     | <small>unitless</small> | `$border-base` |
| `$input-border-color-focus`         | <small>color</small> | <span class="small-box" style="background:#fff"></span> `$blue` |
...
| `$form-group-margin-bottom`         | <small>margin</small> | `1rem` |
| `$custom-select-padding`            | <small>padding</small> | `.375rem 1.75rem .375rem .75rem` |
...
| `$custom-select-multiple`           | <small>unitless</small> | `icon_url` |
| `$custom-select-background-size`    | <small>size</small> | `8px 10px` |
| `$select-background`                | <small>unitless</small> | `$input-background $custom-select-indicator no-repeat right $custom-select-padding-x center` |
| `$select-multiple-background`       | <small>unitless</small> | `$input-background $custom-select-multiple no-repeat right $custom-select-padding-x center` |
